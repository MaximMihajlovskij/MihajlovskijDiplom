...
<html lang="ru">
	<head>
        ...
        <style>
            ...
            */
            ...
            --clr-common-body: #fff;
            --clr-theme-primary: #007bff;
            --clr-theme-secondary: #007bff;
            --clr-theme-grocery: #b18b5e;
            --clr-text-primary: #fff;
            --clr-text-secondary:rgb(75, 73, 73);
            ...
            *::placeholder {
            ...
            /*----------------------------------------*/
            .breadcrumb__thumb {
            background-image: url("{{ asset('storage/banners/edit the image to remove the word _Корзина_ and resize it to 1107 x 113.8.png') }}");
            position: absolute;
            top: 0;
            left: 0;
            height: 100%;
            ...
            .star-rating {
                ...
                padding: 0;
                display: flex;
                gap: 4px; /* Уменьшаем расстояние между звёздами */
            }
            ...
            .star-icon {
                font-size: 20px;
                color: gold; /* Изначально звёзды пустые */
                transition: color 0.3s ease-in-out;
            }

            /* Заполняем звёзды при наведении */
            .star-rating:hover .star-icon {
                color: gold;
            }

            /* Заполняем звёзды слева направо */
            .star-rating li:hover .star-icon,
            .star-rating li:hover ~ li .star-icon {
                color: gold;
            }

            /* Заполняем звёзды после клика */
            .star-icon.selected {
                color: gold;
            }
            ...
            .flash-message {
                ...
                bottom: 20px;
                right: 20px;
                background:rgb(255, 255, 255); /* Зелёный фон */
                color: green;
                font-size: 18px;
                font-weight: bold;
                padding: 12px 18px;
        ...
        /* 🔹 Динамическая синяя граница */
        .scroll-percentage::before {
            content: "";
            position: absolute;
            inset: -4px; /* Располагаем границу вокруг кнопки */
            border-radius: 50%;
            display: block;
            width: calc(100% + 8px);
            height: calc(100% + 8px);
        ...
        .filter-panel {
            position: fixed;
            top: 0;
            right: -320px; /* 🔹 Скрываем фильтр справа */
            width: 300px;
            height: 100%;
            background: #f9f9f9;
            padding: 20px;
        ...
        .filter-section {
            margin-bottom: 20px; /* 🔹 Увеличиваем отступы между блоками */
            padding: 15px;
            border: 1px solid #ccc; /* 🔹 Добавляем тонкую границу */
        ...
        .selected-filters {
            display: flex;
            justify-content: space-between; /* 🔹 Распределяем фильтры и кнопку по краям */
            align-items: center;
            padding: 10px;
        }
        ...
        .delete-avatar-btn {
            position: absolute;
            top: 10px; /* Расположить сверху */
            right: 10px; /* Расположить справа */
            background: rgba(255, 0, 0, 0.7); /* Полупрозрачный фон */
            border: none;
            padding: 8px;
            cursor: pointer;
        }
        ...
        .btn-log>a.reg:hover, .btn-log>a.log:hover {
            border-color: blue; /* Синяя граница при наведении */
            color: blue;
        }
                    ...
                    <div class="mega-menu-wrapper">
                        <div class="header-main-4">
                                    ...
                                    <nav id="mobile-menu">
                                        <ul>
                                            @if(Gate::allows('admin-access'))
                                                <a href="{{ route('admin.scud.index') }}" class="btn btn-primary">Админ-панель</a>
                                            @endif
                                            <li class="has-dropdown">
                                                <a href="">Оборудование</a>
                                                <ul class="submenu">
                                                    <li><a href="{{ route('video') }}">Видеонаблюдение</a></li>
                                                    <li><a href="{{ route('turn') }}">Турникеты</a></li>
                                                    <li><a href="{{ route('barrier') }}">Шлагбаумы</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a href="{{ route('accessories.accessories') }}">Аксессуары</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('portfolio.portfolio') }}">Портфолио</a>
                                            </li>
                                            <li>
                                                <a href="{{route('contact')}}">Оставить заявку</a>
                                            </li>
                                            <li>
                                                <a href="{{route('repair.history')}}">История заявок</a>
                                            </li>
                                            <li>
                                            <a href="{{ route('index') }}#contact-section">Связаться с нами</a>
                                            </li>
                                        </ul>
                                    </nav>
                                </div>
                            ...
                            <div class="header-right d-inline-flex align-items-center justify-content-end">
                                ...
                                <div class="header-action d-flex align-items-center ml-30" style="margin-left: 30px;">
                                <div class="header-action-item">
                                    <a href="{{ route('Wishlist.wishlist') }}" class="header-action-btn">
                                        ...
                                        <span id="wishlist-count" class="header-action-badge bg-furniture">{{ \App\Models\Wishlist::where('user_id', auth()->id())->count() }}</span>
                                    </a>
                                </div>
                                <div class="header-action-item">
                                    <a href="{{ route('cart.cart') }}" class="header-action-btn cartmini-open-btn">
                                ...
                                <div class="header-action-item">
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#userProfileModal" class="header-profile-icon">
                                        @if(auth()->check()) 
                                            <img src="{{ auth()->user()->avatar ? asset('storage/' . auth()->user()->avatar) : asset('storage/banners/аватарка.jpg') }}" alt="Профиль" class="rounded-circle" width="40">
                                        @else
                                            <img src="{{ asset('storage/banners/аватарка.jpg') }}" alt="Гость" class="rounded-circle" width="40">
                                        @endif
                                    </a>
                                </div>
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                @if(auth()->check())
                                                    ...
                                                    @else
                                                        <h5>Профиль пользователя {{ auth()->user()->name }}</h5> 
                                                    @endif
                                                @else
                                                    <h5>Гостевой профиль</h5> 
                                                @endif
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-md-4 text-center">
                                                            <div class="avatar-wrapper">
                                                                @if(auth()->check()) 
                                                                    <img id="avatarPreview" src="{{ auth()->user()->avatar ? asset('storage/' . auth()->user()->avatar) : asset('storage/banners/аватарка.jpg') }}" class="img-fluid rounded-circle mb-3" width="120">
                                                                @else
                                                                    <img id="avatarPreview" src="{{ asset('storage/banners/аватарка.jpg') }}" class="img-fluid rounded-circle mb-3" width="120">
                                                                @endif
                                                                <div class="avatar-actions mt-2 d-flex justify-content-center gap-2">
                                                                    <label class="btn btn-warning btn-sm rounded-circle edit-btn d-none">
                                                                        <i class="fas fa-pencil-alt"></i>
                                                                        <input type="file" name="avatar" id="avatarInput" class="d-none" disabled>
                                                                    </label>
                                                                    @if(auth()->check())
                                                                        <a href="{{ route('profile.deleteAvatar') }}" id="deleteAvatarLink" class="btn btn-danger btn-sm rounded-circle">
                                                        ...
                                                        <!-- 🔹 Поля справа -->
                                                        <div class="col-md-8">
                                                            @foreach(['name' => 'Имя', 'email' => 'Email', 'address' => 'Адрес', 'telephon' => 'Телефон'] as $field => $label)
                                                                <div class="mb-3 d-flex align-items-center gap-2">
                                                                    <label class="form-label w-25">{{ $label }}</label>
                                                                    <input type="text" name="{{ $field }}" id="{{ $field }}Input" class="form-control w-50" value="{{ auth()->check() ? auth()->user()->$field : 'Вы не авторизованы' }}" readonly>
                                                                    <button type="button" class="btn btn-warning btn-sm rounded-circle edit-btn d-none" data-field="{{ $field }}">
                                                                        <i class="fas fa-pencil-alt"></i>
                                                                    </button>
                                                                </div>
                                                            @endforeach
                                                    ...
                                                    <div class="edit-actions d-none mt-3">
                                                        ...
                                                        <button type="button" class="btn btn-secondary w-100 mt-2 cancel-edit">Отменить редактирование</button>
                                                    </div>
                                                </form>
                                                @if(auth()->check())
                                                    <div class="btn-auth">
                                                        <form action="{{ route('logout') }}" method="POST">
                                                            @csrf
                                                            <button type="submit" class="btn btn-v">Выйти</button>
                                                        </form>
                                                        <button type="button" class="btn btn-warning btn-sm edit-profile-btn"><i class="fas fa-pencil-alt"></i></button>
                                                        <form id="deleteAccountForm" action="{{ route('profile.delete') }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="btn btn-del">Удалить аккаунт</button>
                                                        </form>
                                                    </div>
                                                @else
                                                    <div class="btn-log">
                                                        <a href="{{ route('login') }}" class="log">Войти</a>
                                                        <a href="{{ route('register') }}" class="reg">Зарегистрироваться</a>
                                                    </div>
                                ...
                                <div class="header-humbager ml-30" style="margin-left: 30px;">
    ...
    <!-- Header area end -->
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="searchResultsContainer">
                        <!-- Сюда будут загружаться результаты поиска -->
        ...
        @yield('home')
        @yield('content')
        @yield('camera_description')
        @yield('turn_description')
        @yield('barrier_description')
        @yield('accessories_description')
        ...
        <footer class="footer-bg">
            <div class="footer-area pt-100 pb-20 " style="padding-top: 100px; padding-bottom: 20px;">
                <div class="footer-style-4">
                    ...
                    <div class="footer-grid-3">
                        ...
                        <div class="footer-widget-4">
                            ...
                            <div class="footer-link">
                                <ul>
                                    ...
                                    <li><a href="{{ route('turn') }}">Турникеты</a></li>
                                    <li><a href="{{ route('barrier') }}">Шлагбаумы</a></li>
                                    <li><a href="{{ route('accessories.accessories') }}">Аксессуары</a></li>
                                    <li><a href="{{ route('portfolio.portfolio') }}">Портфолио</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="footer-widget-4">
                            ...
                            <div class="footer-link">
                                <ul>
                                    ...
                                    <li><a href="{{ route('cart.cart') }}">Корзина </a></li>
                                    <li><a href="{{ route('Wishlist.wishlist') }}">Избранное</a></li>
                                    <li><a href="{{ route('repair.history') }}">История заявок</a></li>
                                    <li><a href="{{ route('index') }}#contact-section">Связаться с нами</a></li>
                        ...
                        <div class="footer-widget footer-col-4">
                            ...
                            <div class="footer-info mb-35" style="margin-bottom: 35px;">
                                <p class="w-75">Республика Беларусь, Гродненская область, г.Гродно</p>
                                <div class="footer-info-item d-flex align-items-start pb-15 pt-15">
                                <div class="footer-info-icon mr-20" style="margin-right: 20px;">
                                ...
                                <div class="footer-info-text">
                                    <a class="furniture-clr-hover" href="">+375 (33) 872-98-23</a>
            ...
            <div class="container">
                <div class="footer-copyright-area b-t">
                    ...
                    <div class="footer-copyright-text">
                        <p class="mb-0">© ОАО "Системы охраны и безопасности" </p>
                    </div>
                    ...
                    <div class="footer-conditions">
                        <ul>
                            ...
                            <li><a class="furniture-clr-hover" href="#">Политика конфидециаьности</a></li>
                        </ul>
                    </div>
                    </div>
                </div>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                if (!heroSection) return; // 🚀 Проверка на null
                
                function updateNavbar() {
                    var bannerBottom = heroSection.getBoundingClientRect().bottom;
                    if (window.scrollY < bannerBottom - 80) {
                        navbar.classList.remove("scrolled"); // 🚀 Прозрачная на баннере, белый текст
                    } else {
                        navbar.classList.add("scrolled");  // 🚀 Светлый фон, тёмный текст
                    }
                }

                window.addEventListener("scroll", updateNavbar);
                updateNavbar(); // 🚀 Вызываем сразу для начального состояния
            });
        </script>
        <script>
            document.addEventListener("DOMContentLoaded", function () {
        ...
        <!--<script>
            ...
            // Обновляем количество избранных товаров каждые 5 секунд
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.querySelectorAll('.edit-btn').forEach(button => {
                    button.addEventListener('click', function() {
                        ...
                        document.getElementById(field + 'Input').removeAttribute('readonly');
                ...
                document.querySelector('.avatar-actions label').addEventListener('click', function() {
                    document.getElementById('avatarInput').removeAttribute('disabled');
                ...
                document.querySelector('.cancel-edit').addEventListener('click', function() {
                    ...
                    document.getElementById('avatarInput').setAttribute('disabled', 'true');
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.querySelector('.edit-profile-btn').addEventListener('click', function() {
                    document.querySelectorAll('.edit-btn').forEach(btn => btn.classList.remove('d-none')); // Показываем кнопки редактирования
                    document.querySelector('.edit-actions').classList.remove('d-none'); // Показываем "Сохранить"
                    document.getElementById('modalTitle').innerText = 'Редактирование профиля'; // Меняем заголовок
                });
                ...
                document.querySelector('.cancel-edit').addEventListener('click', function() {
                    document.querySelectorAll('.edit-btn').forEach(btn => btn.classList.add('d-none')); // Скрываем кнопки редактирования
                    document.querySelectorAll('input').forEach(input => input.setAttribute('readonly', 'true'));
                    document.querySelector('.edit-actions').classList.add('d-none'); // Скрываем "Сохранить"
                    document.getElementById('modalTitle').innerText = 'Профиль'; // Возвращаем заголовок
                    isEditing = false;
                });
            });
        </script>
        <script>
            document.getElementById('deleteAvatarLink').addEventListener('click', function(event) {
                ...
                .then(data => {
                    if (data.success) {
                        document.getElementById('avatarPreview').src = data.newAvatar; // Обновляем аватар в модалке
                        document.querySelector('.header-profile-icon img').src = data.newAvatar; // Обновляем аватар в шапке
                    } else {
                ...
                function performSearch(query) {
                    ...
                    fetch(`/search?query=${encodeURIComponent(query)}`)
                        ...
                        .then(html => {
                            ...
                            // Инициализируем модальные окна для товаров внутри результатов
                            const productModals = resultsContainer.querySelectorAll('[data-bs-toggle="modal"]');
                            productModals.forEach(el => {
                                el.addEventListener('click', function() {
                                    const targetModalId = this.getAttribute('data-bs-target');
                                    const targetModal = document.querySelector(targetModalId);
                                    if (targetModal) {
                                        const productModal = new bootstrap.Modal(targetModal);
                                        productModal.show();
                                    }
                                });
                            });
                        ...
                        .catch(error => {
                            resultsContainer.innerHTML = `
                                <div class="alert alert-danger">
                                    Произошла ошибка при загрузке результатов: ${error.message}
                                </div>
                            `;
                        });
                }
