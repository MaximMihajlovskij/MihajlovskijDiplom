            ...
            <div class="row align-items-center">
                            ...
                            <nav>
                                <div class="nav nav-tabs flex-nowrap flex-sm-column" id="nav-tab" role="tablist">
                                    <button class="nav-link active" id="img-1-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="true">
                                        @if($barrier->image)
                                            <img src="{{ asset('storage/' . $barrier->image) }}" class="img-fluid" alt="{{ $barrier->name_barrier }}">
                                        @else
                                            <span>Нет фото</span>
                                        @endif
                                    </button>
                ...
                <div class="col-xxl-6 col-lg-6">
                    <div class="product__details-content pr-80">
                        <h3 class="product__details-title text-capitalize">{{ $barrier->name_barrier }}</h3>
                            ...
                            <div class="col-xxl-3 col-xl-4 col-lg-4">
                                <div class="product__details-more-tab mr-15">
                                    ...
                                    <div class="nav nav-tabs flex-column " id="productmoretab" role="tablist">
                                        @if(isset($barrier->description))
                                            <button class="nav-link active" id="nav-description-tab" data-bs-toggle="tab"
                                                data-bs-target="#nav-description" type="button" role="tab"
                                                aria-controls="nav-description" aria-selected="true">Описание
                                            </button>
                                        @endif    
                                ...
                                <div class="product__details-more-tab-content">
                                    ...
                                    <div class="tab-pane fade" id="nav-review" role="tabpanel" aria-labelledby="nav-review-tab">
                                            <div class="product__details-review">
                                                <h3 class="comments-title">{{ $barrier->name_barrier }}</h3>
                                                <div class="latest-comments mb-50">
                                                    <form action="{{ route('barrier.descriptionbarrier', $barrier->id) }}" method="GET" class="d-flex align-items-center gap-2 p-2 border rounded w-auto mt-2">
                                                ...
                                                <div class="product__details-comment section-space-medium-bottom">
                                                    ...
                                                    <form id="review-form" action="{{ route('reviews.store', $barrier->id) }}" method="POST">
                                                        @csrf 
