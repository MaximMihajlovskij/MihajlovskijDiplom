            ...
            <div class="row align-items-center">
                            ...
                            <nav>
                                <div class="nav nav-tabs flex-nowrap flex-sm-column" id="nav-tab" role="tablist">
                                    <button class="nav-link active" id="img-1-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="true">
                                        @if($camera->image)
                                            <img src="{{ asset('storage/' . $camera->image) }}" class="img-fluid" alt="{{ $camera->name_camera }}">
                                        @else
                                            <span>Нет фото</span>
                                        @endif
                                    </button>
                ...
                <div class="col-xxl-6 col-lg-6">
                    <div class="product__details-content pr-80">
                        <h3 class="product__details-title text-capitalize">{{ $camera->name_camera }}</h3>
                                ...
                                <div class="product__details-more-tab-content">
                                    ...
                                    <div class="tab-pane fade" id="nav-review" role="tabpanel" aria-labelledby="nav-review-tab">
                                            <div class="product__details-review">
                                                <h3 class="comments-title">{{ $camera->name_camera }}</h3>
                                                <div class="latest-comments mb-50">
                                                    <form action="{{ route('video.descriptioncamera', $camera->id) }}" method="GET" class="d-flex align-items-center gap-2 p-2 border rounded w-auto mt-2">
                                                ...
                                                <div class="product__details-comment section-space-medium-bottom">
                                                    ...
                                                    <form id="review-form" action="{{ route('reviews.store', $camera->id) }}" method="POST">
                                                        @csrf 
