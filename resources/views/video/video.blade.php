            ...
            <div class="container">
                ...
                <div class="col-xxl-12">
                    <div class="breadcrumb__wrapper text-center">
                        <h2 class="breadcrumb__title">Видеонаблюдение</h2>
         ...
         <div class="container">
            <div class="row">
               <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                  <div class="bd-product__result mb-30">
                        <h4>Видеокамер на странице: {{ $cameras->count() }}</h4>
                  </div>
               </div>
               <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-6">
                ...
                <div class="filter-panel">
                    ...
                    <form method="GET" action="{{ route('video') }}" class="filter-container">
                        <!-- 🔹 Фильтр по поиску -->
                    ...
                    <div class="product__filter-tab">
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="row g-5">
                                ...
                                @endif
                                @if ($cameras->isEmpty())
                                    <p class="text-danger">В базе данных нет видеокамер</p>
                                @else 
                                        ...
                                        <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                            ...
                                            <div class="product-item">
                                                ...
                                                <button type="button" class="product-action-btn" data-bs-toggle="modal"
                                                    data-bs-target="#producQuickViewModal-{{ $camera->id }}">
            ...
            <div class="row">
               <div class="bd-basic__pagination mt-50 d-flex align-items-center justify-content-center" style="margin-top: 50px;">
                  <nav>
                     <ul>
                        @if ($cameras->currentPage() > 1)
                            <li>
                                <a href="{{ $cameras->previousPageUrl() }}">
                                    <i class="fa-solid fa-angle-left" style="display: inline-block; visibility: visible; font-size: 18px;"></i>
                                </a>
                            </li>
                        @endif

                        @foreach ($cameras->getUrlRange(1, $cameras->lastPage()) as $page => $url)
                            @if ($page == $cameras->currentPage())
                        ...
                        @if ($cameras->currentPage() < $cameras->lastPage())
                            <li>
                                <a href="{{ $cameras->nextPageUrl() }}">
