            ...
            <div class="container">
                ...
                <div class="col-xxl-12">
                    <div class="breadcrumb__wrapper text-center">
                        <h2 class="breadcrumb__title">Турникеты</h2>
         ...
         <div class="container">
            <div class="row">
               <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                  <div class="bd-product__result mb-30">
                        <h4>Турникетов на странице: {{ $turnikets->count() }}</h4>
                  </div>
               </div>
               <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-6">
                ...
                <div class="filter-panel">
                    ...
                    <form method="GET" action="{{ route('turn') }}" class="filter-container">
                        <!-- 🔹 Фильтр по поиску -->
                    ...
                    <div class="product__filter-tab">
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="row g-5">
                                ...
                                @endif
                                @if ($turnikets->isEmpty())
                                    <p class="text-danger">В базе данных нет турникетов</p>
                                @else 
                                        ...
                                        <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                            <div class="product-item">
                                                ...
                                                <button type="button" class="product-action-btn" data-bs-toggle="modal"
                                                    data-bs-target="#producQuickViewModal-{{ $turniket->id }}">
            ...
            <div class="row">
               <div class="bd-basic__pagination mt-50 d-flex align-items-center justify-content-center" style="margin-top: 50px;">
                  <nav>
                     <ul>
                        @if ($turnikets->currentPage() > 1)
                            <li>
                                <a href="{{ $turnikets->previousPageUrl() }}">
                                    <i class="fa-solid fa-angle-left" style="display: inline-block; visibility: visible; font-size: 18px;"></i>
                                </a>
                            </li>
                        @endif

                        @foreach ($turnikets->getUrlRange(1, $turnikets->lastPage()) as $page => $url)
                            @if ($page == $turnikets->currentPage())
                        ...
                        @if ($turnikets->currentPage() < $turnikets->lastPage())
                            <li>
                                <a href="{{ $turnikets->nextPageUrl() }}">
